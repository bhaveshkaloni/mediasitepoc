...
property={
		...
		"sling.servlet.paths=" + "/bin/getHeightDetails"
})
@ServiceDescription("Get Weather Servlet")
public class GetWaterHeightDetails extends SlingSafeMethodsServlet {
	...
	protected void doGet(final SlingHttpServletRequest req,
		...
		try {
			...
			String heightParam = req.getParameter("heights");			
			int heightParamInt = Integer.valueOf(heightParam);			
			...
			while(resourceIterator.hasNext()) {				
				...
				if(heightInt>heightParamInt) {					
					json.put("WaterHeight",heightInt);	
					json.put("Date", date);					
				}				
				out.print(json);
			}
